...
void __attribute__((interrupt, no_auto_psv)) _CNInterrupt(void) {
    ...
    if (PORTAbits.RA0 == 0) {
        lastButtonChanged = 1;
        //writeString(boldFont, 0x6, 0x3, "Button 1");
    }
    if (PORTAbits.RA1 == 0) {
        lastButtonChanged = 2;
        //writeString(boldFont, 0x6, 0x3, "Button 2");
    }
    if (PORTAbits.RA2 == 0) {
        lastButtonChanged = 3;
        ///writeString(boldFont, 0x6, 0x3, "Button 3");
    }
    if (PORTAbits.RA3 == 0) {
        lastButtonChanged = 4;
        //writeString(boldFont, 0x6, 0x3, "Button 4");
    }
}